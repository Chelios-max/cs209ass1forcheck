...
public class LocalAnalyzerTest {
    ...
    static void setUp() {
        try {
            ...
            courseInfo = constructor.newInstance("/Users/guodenghao/IdeaProjects/CS209Ass1-12011910/src/main/resources/local.csv");
//            resources/local.csv
    ...
    void testGetPtcpCountByInst() {
        try {
            ...
            String expected = Files.readString(Paths.get("src","main","resources", "local_answer", "Q1.txt"),
