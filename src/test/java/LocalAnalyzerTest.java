...
//            resources/local.csv
  ...
  void testGetPtcpCountByInst() {
    try {
      ...
      String expected = Files.readString(
              Paths.get("src", "main", "resources", "local_answer", "Q1.txt"),
  ...
  void testGetPtcpCountByInstAndSubject() {
    try {
      ...
      assertTrue(res instanceof Map<?, ?>);
      String expected = Files.readString(
              Paths.get("src", "main", "resources", "local_answer", "Q2.txt"),
              StandardCharsets.UTF_8)
          .replace("\r", "").strip();
      assertEquals(expected, mapToString(res));
    } catch (NoSuchMethodException | InvocationTargetException |
  ...
  void testGetCourseListOfInstructor() {
    try {
      ...
      assertTrue(res instanceof Map<?, ?>);
      String expected = Files.readString(
              Paths.get("src", "main", "resources", "local_answer", "Q3.txt"),
              StandardCharsets.UTF_8)
          .replace("\r", "").strip();
  ...
  void testGetCourses() {
    try {
      ...
      String expected1 = Files.readString(
              Paths.get("src", "main", "resources", "local_answer", "Q4_1.txt"),
              StandardCharsets.UTF_8)
          .replace("\r", "").strip();
      ...
      String expected2 = Files.readString(
              Paths.get("src", "main", "resources", "local_answer", "Q4_2.txt"),
              StandardCharsets.UTF_8)
          .replace("\r", "").strip();
  ...
  void testSearchCourses() {
    try {
      ...
      assertTrue(res1 instanceof List<?>);
      String expected1 = Files.readString(
              Paths.get("src", "main", "resources", "local_answer", "Q5_1.txt"),
              StandardCharsets.UTF_8)
          .replace("\r", "").strip();
      assertEquals(expected1, listToString(res1));
      ...
      assertTrue(res2 instanceof List<?>);
      String expected2 = Files.readString(
              Paths.get("src", "main", "resources", "local_answer", "Q5_2.txt"),
              StandardCharsets.UTF_8)
          .replace("\r", "").strip();
      assertEquals(expected2, listToString(res2));
    } catch (NoSuchMethodException | InvocationTargetException |
  ...
  void testRecommendCourses() {
    try {
      ...
      assertTrue(res1 instanceof List<?>);
      String expected1 = Files.readString(
              Paths.get("src", "main", "resources", "local_answer", "Q6_1.txt"),
              StandardCharsets.UTF_8)
          .replace("\r", "").strip();
      assertEquals(expected1, listToString(res1));
      ...
      assertTrue(res2 instanceof List<?>);
      String expected2 = Files.readString(
              Paths.get("src", "main", "resources", "local_answer", "Q6_2.txt"),
              StandardCharsets.UTF_8)
          .replace("\r", "").strip();
      assertEquals(expected2, listToString(res2));
      Object res3 = method.invoke(courseInfo, 35, 1, 0);
      assertTrue(res3 instanceof List<?>);
      String expected3 = Files.readString(
              Paths.get("src", "main", "resources", "local_answer", "Q6_3.txt"),
              StandardCharsets.UTF_8)
          .replace("\r", "").strip();
